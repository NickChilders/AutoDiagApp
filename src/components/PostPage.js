...
const PostPage = () => {
  ...
  **************************************************************************/
  ...
  const handleShowCommentBox = (event) => {
    event.preventDefault();
  ...
  return (
    <div>
      ...
      <section>
        <div className="box-main">
          {!showCommentBox && (
            <Button variant="primary" style={{ margin: "20px", height: "auto", width: "auto" }} className="btn btn-primary" onClick={handleShowCommentBox}>{"Add Comment"}</Button>
          )}
          {showCommentBox && (
            <div className="post-comment">
              <Form onSubmit={handleSubmit}>
                ...
                <Button style={{ margin: "20px", height: "auto", width: "auto" }} className="btn btn-danger" onClick={handleCancelComment}>{"Cancel"}</Button>
              </Form>
            </div>
          )}
        </div>
